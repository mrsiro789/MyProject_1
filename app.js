...
const server = http.createServer((req, res) => {
  ...
  res.end('<h1>Hello K29</h1>' + 
			...
			'<table style="border:1px solid black;">' +
			  ...
			  '</tr>' +
			  '<tr>' +
				'<td style="border:1px solid black;width:100px">M2522010</td>' +
			  ...
			  '</tr>' +
			  '<tr>' +
				'<td style="border:1px solid black;width:100px">M2522001</td>' +
			  ...
			  '</tr>' +
			  '<tr>' +
				'<td style="border:1px solid black;width:100px">M2522002</td>' +
